...
Query.prototype._find = function(callback) {
  ...
  return Query.base.find.call(this, {}, getFindCallback(completeMany, self, options, self.model, fields, callback));
};
...
Query.prototype._findOne = function(callback) {
  ...
  Query.base.findOne.call(self, {}, 
    getFindCallback(function(model, docs, fields, self, pop, callback){
      completeOne(model, docs, null, fields, self, pop, callback);
    }, self, options, self.model, projection, callback));
};
...
function getFindCallback(completeAs, self, options, model, fields, callback) {
    return function(err, docs) {
        // debugger
        if (err) return callback(err);

        if (!docs) return callback(null, docs);
        if (0 === docs.length) return callback(null, docs);
        ...
        if (!self._mongooseOptions.populate && !self._mongooseOptions.relate) {
            ...
            }) : completeAs(model, docs, fields, self, null, callback);
        }
        ...
        function done(err, docs) {
            ...
            return true === options.lean ? QCB(self._mongooseOptions, docs, function(err, result) {
                if (err) return callback(err);
                return callback(null, result);
            }) : completeAs(model, docs, fields, self, pop, callback);
        }
