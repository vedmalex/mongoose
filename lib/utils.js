...
/*!
 * Relate options constructor
 */

function RelateOptions(options) {
    if (!(options.hasOwnProperty('relName') && options.hasOwnProperty('propName') && options.hasOwnProperty('from') && options.hasOwnProperty('to') && options.hasOwnProperty('ref') && options.hasOwnProperty('single') && options.hasOwnProperty('embedded') && options.hasOwnProperty('oppositeEmbedded'))) {
        // console.log(options);
        throw new Error("Invalid Options for relate Operation");
    }
    ...
    this.oppositeEmbedded = options.oppositeEmbedded || false;
    // ??? 
    this.populate = options.populate;
    this.fromAggregation = options.fromAggregation;
    this.toAggregation = options.toAggregation;
    this.fromKeyField = options.fromKeyField || "_id";
    this.toKeyField = options.toKeyField || "_id";
    this.relationModel = options.relationModel;
    this.derivation = options.derivation;
    this.oppositeSingle = options.oppositeSingle;
    this.model = options.model;
    this.normRelName = options.normRelName;
    this.relCardinality = options.relCardinality;
    this.settings = options.settings;
    this.derived = options.derived;
    this.onlyIds = options.onlyIds;
    this.ensure = options.ensure;
    this.absent = options.absent;
}
// compatibility with utils.clone
RelateOptions.prototype.constructor = Object;
