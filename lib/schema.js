...
Schema.prototype.path = function(path, obj) {
  ...
  var typeDef = this.paths[path] = Schema.interpretAsType(path, obj, this.options);
  if (typeDef.$isSingleNested) {
    ...
    if (typeDef.caster
      && typeDef.caster.options
      && typeDef.caster.options.virtualRel)
    this.virtualRels[path] = 1;
