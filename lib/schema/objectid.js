...
ObjectId.prototype.cast = function (value, doc, init, populate) {
  if (SchemaType._isRef(this, value, init || populate))
    return value;

  if (this.options && this.options.ref && populate)
    return new (doc.model(this.options.ref))(value);
